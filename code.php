...
<h1 class="text-9 font-weight-bold">Activation</h1>
...
<h4 class="color-primary font-weight-semibold text-4 text-uppercase mb-3">Enter Code</h4>
<form action="/" id="frmSignIn" method="post" class="needs-validation" novalidate="novalidate">
<div class="form-row">
<div class="form-group col">

<input type="text" name="username" value="" class="form-control form-control-lg" required="" placeholder="#########">
</div>
</div>
