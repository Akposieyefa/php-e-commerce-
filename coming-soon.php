    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-12 align-self-center p-static order-2 text-center">
                <h1 class="text-9 font-weight-bold">Coming Soon</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col text-center">
                <h2 class="font-weight-normal text-7 mb-2"><strong class="font-weight-extra-bold">This Feature is Coming Soon</strong></h2>
                <p class="mb-0 lead">We bring to your notice that this feature is coming soon. </p>
            </div>
        </div>
        <div class="row">
            <div class="col">
