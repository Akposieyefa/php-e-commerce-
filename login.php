...
<input type="submit" value="Login" class="btn btn- dds btn-modern float-right" data-loading-text="Loading...">
</div>
<a class="" href="./register.html">(Don't have an Account? Register now)</a>
</div>
</form>
</div>
</div>
